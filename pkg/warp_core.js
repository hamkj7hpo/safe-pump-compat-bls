...
export function bls_sign(message, secret_bytes) {
    ...
    return BlsSignature.__wrap(ret);
}
...
export class BlsKeypair {
    ...
    get secret() {
        try {
            ...
            wasm.blskeypair_secret(retptr, this.__wbg_ptr);
    ...
    get public() {
        try {
            const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
            wasm.blskeypair_public(retptr, this.__wbg_ptr);
            var r0 = getDataViewMemory0().getInt32(retptr + 4 * 0, true);
            var r1 = getDataViewMemory0().getInt32(retptr + 4 * 1, true);
            var v1 = getArrayU8FromWasm0(r0, r1).slice();
            wasm.__wbindgen_free(r0, r1 * 1, 1);
...
export class BlsSignature {
    ...
    get sig() {
        try {
            const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
            wasm.blssignature_sig(retptr, this.__wbg_ptr);
            var r0 = getDataViewMemory0().getInt32(retptr + 4 * 0, true);
            var r1 = getDataViewMemory0().getInt32(retptr + 4 * 1, true);
            var v1 = getArrayU8FromWasm0(r0, r1).slice();
            wasm.__wbindgen_free(r0, r1 * 1, 1);
...
function __wbg_get_imports() {
    ...
    imports.wbg.__wbg_getRandomValues_8afe083a24c06587 = function() { return handleError(function (arg0, arg1) {
        const ret = getObject(arg0).getRandomValues(getObject(arg1));
        return addHeapObject(ret);
    }, arguments) };
